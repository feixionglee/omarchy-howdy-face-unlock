...
PATCHES = [
    ...
    (
        ...
        '    if (lockRequested && sessionLock.secure && howdyConfigured) {\n'
    ...
    (
        ...
        '        pendingSessionLockTimer.stop()\n'
        '        root.startFingerprint()\n'
        '        // Face auth intentionally does not start here. A manual lock\n'
        '        // must stay locked while the user is still sitting in front of\n'
        '        // the camera; Howdy starts only from a later wake/activity.\n'
        '      }\n'
        '    }\n'
    ),
    (
    ...
    (
        ...
        '      if (!root.howdyConfigured) { if (howdyPam.active) howdyPam.abort(); howdyRetryTimer.stop() }\n'
        '    }\n'
        '  }\n'
    ),
    (
